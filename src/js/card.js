...
let randomNumber1 =
  Math.floor(Math.random() * (maximum1 - minimum + 1)) + minimum;
...
const opponentCardsRotations = [
  ...
  new Vector3(2 * Math.PI, Math.PI, 0.1),
...
let randomNumber2 =
  Math.floor(Math.random() * (maximum2 - minimum + 1)) + minimum;

const card6 = new Mesh(cardGeo, card6Mat);
configureCard(
  card6,
  opponentCardsPositions,
  opponentCardsRotations,
  randomNumber2,
  "slave"
);
